        ...
        for row in reconciled_rows:
            try:
                safe_insert_reconciliation_detail(
                    ...
                    broker_entry_price=row.get("broker_entry_price") or None,
                    local_exit_price=row.get("local_exit_price") or None,
                    broker_exit_price=row.get("broker_exit_price") or None,
                    local_shares=row.get("local_shares") or None,
                    broker_entry_qty=row.get("broker_entry_qty") or None,
                    broker_exit_qty=row.get("broker_exit_qty") or None,
                    local_exit_reason=row.get("local_exit_reason"),
                    broker_exit_reason=row.get("broker_exit_reason"),
                    broker_exit_order_id=row.get("broker_exit_order_id"),
