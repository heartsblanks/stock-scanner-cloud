...
class SchedulerOpsTests(unittest.TestCase):
    def test_market_ops_plan_at_950_runs_sync_and_scan(self):
    ...
    def test_market_ops_plan_at_1555_runs_sync_and_close(self):
        ...
        self.assertEqual(build_market_ops_plan(now_ny), ["sync", "close"])

    def test_market_ops_plan_at_1615_runs_sync_only(self):
        now_ny = datetime(2026, 4, 1, 16, 15, tzinfo=NY_TZ)
